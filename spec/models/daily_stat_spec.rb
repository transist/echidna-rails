...
describe DailyStat do
  ...
  describe ".top_trends" do
    ...
    it "returns word1, word3 and word2 for group 1" do
      expect(DailyStat.top_trends(1)).to eq [
    ...
    it "checks history for only 1 hour" do
      expect(DailyStat.top_trends(1, days: 1)).to eq [
    ...
    it "query 2 days data" do
      expect(DailyStat.top_trends(1, days: 20)).to eq [
        {word: "word1", z_score: 1.3851386144545532},
        {word: "word3", z_score: 1.356305321707554},
        {word: "word2", z_score: 1.1815597860975298}
      ]
    end
  end
end
